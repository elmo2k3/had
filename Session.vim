...
silent only
cd ~/Projekte/home-automation/had
...
badd +1 Makefile
badd +1 mpd/main.c
badd +10 libmpdclient.c
badd +1 libmpdclient.h
badd +1 example.c
badd +69 database.c
badd +34 mpd.c
badd +6 mpd.h
...
silent! normal! zE
let s:l = 89 - ((12 * winheight(0) + 24) / 49)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 132 - ((9 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 84 - ((7 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 123 - ((18 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
123
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
